...
public class Delfin extends Pez{
    ...
    public Delfin(int altura, int peso, int edad, String habitat, Boolean tieneBranquias, int numeroAletas,
                  String nombreCientifico, String nombre, String territorio, String sonido) {
        super(altura, peso, edad, habitat, tieneBranquias, numeroAletas);
